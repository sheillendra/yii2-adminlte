        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        <?php echo $this->title ?>
                        <small><?php echo isset($this->params['smallTitle']) ? $this->params['smallTitle'] : '' ?></small>
                    </h1>
                    <?php
                    echo Breadcrumbs::widget([
                        'tag' => 'ol',
                        'encodeLabels' => false,
                        'homeLink' => ['label' => '<i class="fa fa-dashboard"></i> ' . Yii::t('app', 'Home'), 'url' => ['/']],
            ...
            <?php echo $this->render('@app/views/layouts/main-footer'); ?>
