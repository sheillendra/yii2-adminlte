...
namespace sheillendra\adminlte\gii\generators\crud;
...
class Generator extends \yii\gii\Generator {
    ...
    public $iconClass = 'fa fa-forward';
    ...
    public function getDescription() {
        return 'This generator generates a controller and views that implement CRUD (Create, Read, Update, Delete)
            operations for the specified data model in <code>AdminLTE</code> template.';
    }
    ...
    public function hints() {
        return array_merge(parent::hints(), [
            ...
            'viewPath' => 'Specify the directory for storing the view scripts for the controller. You may use path alias here, e.g.,
                ...
                to <code>@app/themes/adminlte/views/ControllerID</code>',
            'iconClass' => 'Class name of icon will use in sidebar menu, Default value is <code>fa fa-forward</code>',
    ...
    public function getViewPath() {
        if (empty($this->viewPath)) {
            return Yii::getAlias('@app/themes/adminlte/views/' . $this->getControllerID());
        } else {
    ...
    public function getLayoutPath() {
        if (empty($this->viewPath)) {
            return Yii::getAlias('@app/themes/adminlte/views/layouts');
        } else {
            $path = strrpos(Yii::getAlias(str_replace('\\', '/', $this->viewPath)), '/');
